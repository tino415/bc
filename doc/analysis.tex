...
\begin{figure}\begin{center}\includegraphics[scale=0.55]{keywordprfile}
\caption{Ukážka profilu kľúčových slov.}\label{Profil klúčovích slov}
...
\begin{figure}\begin{center}\includegraphics[scale=0.55]{semanticnetwork}
