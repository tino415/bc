...
jeho modifikácia podľa \cite{modified_bm25}
...
\paragraph{Párovanie na základe unikátnych pojmov}

\paragraph{Párovanie na základe váh}

spočíva v sčítaní váh slov ktoré sú vyhľadávané a zároveň sú 
v dokumente:

\[w_{d_i} = \sum\limits_{z=1}^{N_{d_t}} f_{t_z} * w(t_z)\]

\paragraph{Jazykový model(angl. Language Model)}
